        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_sessionItems_Ranks_RarityId",
                        column: x => x.RarityId,
                        principalTable: "Ranks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_sessionItems_Sessions_Item_SessionId2",
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_sessionItems_Sessions_SessionId1",
                        column: x => x.SessionId1,
                        principalTable: "Sessions",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_sessionItems_Sessions_SessionId2",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_sessionItems_Item_SessionId2",
                table: "sessionItems",
                column: "Item_SessionId2");

            migrationBuilder.CreateIndex(
                name: "IX_sessionItems_RarityId",
                table: "sessionItems",
                column: "RarityId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_sessionItems_SessionId1",
                table: "sessionItems",
                column: "SessionId1");

            migrationBuilder.CreateIndex(
                name: "IX_sessionItems_SessionId2",
                table: "sessionItems",
                column: "SessionId2");
